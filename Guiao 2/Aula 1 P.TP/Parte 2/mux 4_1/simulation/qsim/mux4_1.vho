...
-- Equation(s):
-- \dataOut~0_combout\ = (\sel[1]~input_o\ & (((\sel[0]~input_o\)))) # (!\sel[1]~input_o\ & ((\sel[0]~input_o\ & (\dataIn[1]~input_o\)) # (!\sel[0]~input_o\ & ((\dataIn[0]~input_o\)))))
...
-- Equation(s):
-- \dataOut~1_combout\ = (\sel[1]~input_o\ & ((\dataOut~0_combout\ & ((\dataIn[3]~input_o\))) # (!\dataOut~0_combout\ & (\dataIn[2]~input_o\)))) # (!\sel[1]~input_o\ & (((\dataOut~0_combout\))))
